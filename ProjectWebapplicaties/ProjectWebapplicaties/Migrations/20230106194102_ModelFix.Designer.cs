...
namespace ProjectWebapplicaties.Migrations
{
    ...
    [Migration("20230106194102_ModelFix")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectWebapplicaties.Models.Pizza", b =>
                {
                    ...
                    b.Property<int?>("BestellingPizzaId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BestellingPizzaId");

                    b.HasIndex("PizzaGrootteId");
            ...
            modelBuilder.Entity("ProjectWebapplicaties.Models.Pizza", b =>
                {
                    b.HasOne("ProjectWebapplicaties.Models.BestellingPizza", "BestellingPizza")
                        .WithMany("Pizzas")
                        .HasForeignKey("BestellingPizzaId");

                    b.HasOne("ProjectWebapplicaties.Models.PizzaGrootte", "PizzaGrootte")
                        .WithMany("Pizzas")
                        .HasForeignKey("PizzaGrootteId");
                });
